...
/* package KafkaConsumerProducerTool-0.1.0.0 */
#define VERSION_KafkaConsumerProducerTool "0.1.0.0"
#define MIN_VERSION_KafkaConsumerProducerTool(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package hw-kafka-client-2.0.1 */
#define VERSION_hw_kafka_client "2.0.1"
...
#define CURRENT_COMPONENT_ID "KafkaConsumerProducerTool-0.1.0.0-EfYvclGLZFxJOsobQ2F0Qe"

#define CURRENT_PACKAGE_KEY "KafkaConsumerProducerTool-0.1.0.0-EfYvclGLZFxJOsobQ2F0Qe"
